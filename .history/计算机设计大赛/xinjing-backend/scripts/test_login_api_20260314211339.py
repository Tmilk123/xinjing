...
def main() -> int:
    ...
    parser.add_argument("--username", default="test001", required=True, help="Username or email used for login")
    parser.add_argument("--password", default="12345678",required=True, help="Password used for login")
    parser.add_argument(
        "--expect-fail",
        action="store_true",
